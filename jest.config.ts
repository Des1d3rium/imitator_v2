...
const config: Config = {
  // All imported modules in your tests should be mocked automatically automock: false,

  // Stop running tests after `n` failures bail: 0,

  // The directory where Jest should store its cached dependency information cacheDirectory:
  // "C:\\Users\\Daniel\\AppData\\Local\\Temp\\jest",
  ...
  // An array of regexp pattern strings used to skip coverage collection coveragePathIgnorePatterns:
  // [ "\\\\node_modules\\\\" ],

  // Indicates which provider should be used to instrument code for coverage
  coverageProvider: "v8",

  // A list of reporter names that Jest uses when writing coverage reports coverageReporters: [
  // "json", "text", "lcov", "clover" ],

  // An object that configures minimum threshold enforcement for coverage results coverageThreshold:
  // undefined,

  // A path to a custom dependency extractor dependencyExtractor: undefined,

  // Make calling deprecated APIs throw helpful error messages errorOnDeprecated: false,

  // The default configuration for fake timers fakeTimers: { "enableGlobally": false },
  ...
  // An array of file extensions your modules use moduleFileExtensions: [ "js", "mjs", "cjs", "jsx",
  // "ts", "tsx", "json", "node" ],
  ...
  // An enum that specifies notification mode. Requires { notify: true } notifyMode:
  // "failure-change",
  ...
  // The test environment that will be used for testing testEnvironment: "jest-environment-node",
  ...
  // The glob patterns Jest uses to detect test files testMatch: [ "**/__tests__/**/*.[jt]s?(x)",
  // "**/?(*.)+(spec|test).[tj]s?(x)" ],

  // An array of regexp pattern strings that are matched against all test paths, matched tests are
  // skipped testPathIgnorePatterns: [ "\\\\node_modules\\\\" ],
  ...
  // files will skip transformation transformIgnorePatterns: [ "\\\\node_modules\\\\",
  // "\\.pnp\\.[^\\\\]+$" ],
